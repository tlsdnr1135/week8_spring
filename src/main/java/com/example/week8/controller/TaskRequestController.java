...
public class TaskRequestController {
    ...
    public ResponseEntity<Resource> downFiles(@RequestParam(value="fileName", required = true) String fileName, HttpServletResponse response) throws Exception {
        HttpHeaders httpHeaders = new HttpHeaders();
        httpHeaders.add("Content-Type", "text/csv; charset=x-windows-949");
