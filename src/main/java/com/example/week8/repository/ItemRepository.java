...
public interface ItemRepository extends JpaRepository<Item,Long> {
    ...
    @Query(value = "select i.item_id as 'key', i.adult_yn as adultYn, i.item_act_yn as itemActYn, i.item_no as itemNo,i.item_name as itemName, i.item_org_cost as itemOrgCost, a.ad_use_config_yn as adUseConfigYn, a.ad_id as adId \n" +
            "    from item i \n" +
